	...
	<div class="col-md-12">
		<div class="ms-panel">
			<div class="ms-panel-header d-flex justify-content-between">
				<h6>Sales Quote</h6>
				<a href="{{ route('sale-quoteTest.create') }}" class="btn btn-dark"> add new </a>
			</div>
					...
					<table id="courseEval" class="dattable table table-striped thead-dark  w-100">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="{{ route('sale-quoteTest.edit',$row->id) }}" class="btn btn-info d-inline-block">edit</a>
									<a href="#" onclick="destroy('this sale-quote','{{$row->id}}')" class="btn d-inline-block btn-danger">delete</a>
									<form id="delete_{{$row->id}}" action="{{ route('sale-quoteTest.destroy', $row->id) }}" method="POST" style="display: none;">
										@csrf
										@method('DELETE')
